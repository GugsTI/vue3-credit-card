...
var v = function() {
  ...
  return r2 = n2, (i2 = [{ key: "init", value: function() {
    ...
    if (e2 && e2.type) {
      ...
      var i3 = e2.value;
      this._opts.preprocessor && (i3 = this._opts.preprocessor(i3)), e2.value = s(i3, e2.dataset.mask, this._opts.tokens), t2 && t2.inputType === "insertText" && r3 === a2.length && (r3 = e2.value.length), function(e3, t3, n4) {
...
var d;
var h = (d = new WeakMap(), function(e2, t2) {
